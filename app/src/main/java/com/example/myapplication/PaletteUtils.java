...
public class PaletteUtils {
    ...
    public static Bitmap getDominantGradient(Bitmap bitmap, int height, int width) {
        ...
        int[] colors = new int[]{Color.WHITE, Color.parseColor(topHex), Color.parseColor(bottomHex)};
        //int[]colors = new int[]{ Color.GREEN,Color.BLACK};

        Shader mShader = new LinearGradient(0, 0, width, height, colors, null, Shader.TileMode.CLAMP);
        Matrix m = new Matrix();
        //m.setRotate(30);
